...
public class MeshGenerator : MonoBehaviour {
	...
	void MeshFromPoints(params Node[] points)
	{
		...
		// 3 = number of params in the call of MeshFromPoints in the previous method
		if (points.Length >= 3)
		{
	...
	public class Square
	{
		...
		public Square(ControlNode _topLeft, ControlNode _topRight, ControlNode _bottomRight, ControlNode _bottomLeft)
		{
			...
			// we'll look at each control node and check if they are active or not
			if (topLeft.active)
			{
				configuration += 8;
			}
	...
	{
		// if it's active = wall, !wall if !active
		public bool active;
